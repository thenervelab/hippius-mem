...
to the MCP handshake — or set `auto_init = true` in `hippius-mem.toml` and it runs the
same provisioning as `init` there automatically (Claude Code sessions only; see
